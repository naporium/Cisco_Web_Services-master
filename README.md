...
###__NOTE:__ 
This code appears as the result of a curricular internship  (March 2019/July 2019, 750 Hours) <br>carried out 
 at the [University of Coimbra](https://www.uc.pt)
 [SGSIIC](https://www.uc.pt/sgsiic),  under a course of __120 ECT's__,<br> 
 in Computer Systems and Network Administration at <br>
 __ISEC - Coimbra Institute of Engineering__ [(Instituto Superior de Engenharia de Coimbra)](https://www.isec.pt/EN/).
...
2. **Description:**
       A series of webservices that allow clients to interact with cisco network devices.
        ...
        For detailed information on what we are expecting for each service, check webservices definitions (API DOCUMENTATION)
        ...
        # use the file yaml and use online swagger editor:

3. Who can use the tool:
    - Network and system administrators that work in an environment where Cisco Devices are prevalent, <br>
      and want to Code the Infrastructure.
    - It's also possible to build/integrate a WEB frontend, so that, network and systems administrators could configure Cisco network devices, in a friendly manner. 
    

4. Application deployment: Installation and first-time-setup
...
---  
 ...
 1. Install the required  packages **(We could check requirements.txt)**
    ...
    1.1 Manual instalation of Python Packages     
      - [x] pip install flask
      - [x] pip install flask-swagger-ui
      - [x] pip install netmiko
      
    1.2 We can install via pip using the requirements.txt file instead of manual installation
 ...
 5. **API Documentation URL:**
    ...
    - **Swagger/OpenApi specification**:
        ...
        <br>
         - WE have a file called **'tests.postman_collection.json'** stored in project folder **/postman_Collection**
